...
namespace DAL
{
    ...
    public partial class QLHSBAEntities : DbContext
    {
        ...
        public virtual int InsertService(string serviceName, Nullable<int> servicePrice, Nullable<byte> status)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("InsertService", serviceNameParameter, servicePriceParameter, statusParameter);
        }
